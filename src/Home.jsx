      ...
      <div className="content-row">
        <div className="left-box">
          <div className="about">
            <h4>About me</h4>
            <p>
              Describe me? Well, I LOVE coding, probably an unhealthy amount of
              it. Why? There's always something new to learn, and that suits my
              personality, and I'm not sorry I figured that out after 17 years
              in construction, I'm just glad I did.
            </p>
            <p>
